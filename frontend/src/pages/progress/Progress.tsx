...
export default function Progress() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center min-h-[60vh]">
      <h1 className="text-3xl font-bold text-[#1A1D21] mb-4">Progress</h1>
      <p className="text-lg text-gray-500 mb-6">Track your skills, milestones, learning activity, and readiness.</p>
