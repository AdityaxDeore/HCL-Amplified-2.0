...
import { MessageSquare, Plus, Search, ChevronRight, Zap, Target, BookOpen } from 'lucide-react';
import { mockChatConversations, mockSuggestedPrompts } from '../../data/mockChat';
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-8 pb-8 flex-1 overflow-y-auto custom-scrollbar">
        ...
        <div className="mb-10 text-center max-w-2xl mx-auto mt-8">
          ...
          <h1 className="text-4xl font-bold text-[#1A1D21] tracking-tight mb-4">AI Learning Assistant</h1>
          <p className="text-lg text-gray-500">Your personalized companion for your journey to becoming an {learner.targetRole}. Ask anything about your roadmap, concepts, or resources.</p>
        </div>
                ...
                {filteredConversations.map(conv => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-bold text-[#1A1D21] truncate mb-1">{conv.title}</h3>
                      <p className="text-sm text-gray-500 truncate">{conv.preview}</p>
                    </div>
                    <div className="flex flex-col items-end gap-2 flex-shrink-0">
                      <span className="text-xs font-semibold text-gray-400">{conv.date}</span>
