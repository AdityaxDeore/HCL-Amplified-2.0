...
export default function Preferences() {
  ...
  const [hours, setHours] = useState(learner.availableHoursPerWeek);
  ...
  function handleSave() {
    updateLearnerProfile({ availableHoursPerWeek: hours, interests });
    setSaved(true);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
          ...
          <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Based on your {learner.targetMonths}-month timeline, we recommend at least 10 hours/week.</p>
            </div>
          </div>
