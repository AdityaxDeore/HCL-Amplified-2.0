...
export default function Goals() {
  ...
  const [goal, setGoal] = useState(learner.primaryGoal);
  const [role, setRole] = useState(learner.targetRole);
  const [months, setMonths] = useState(learner.targetMonths);
  const [saved, setSaved] = useState(false);

  function handleSave() {
    updateLearnerProfile({ primaryGoal: goal, targetRole: role, targetMonths: months });
    setSaved(true);
