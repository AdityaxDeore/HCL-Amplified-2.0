...
export default function Learning() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center min-h-[60vh]">
      <h1 className="text-3xl font-bold text-[#1A1D21] mb-4">Learning</h1>
      <p className="text-lg text-gray-500 mb-6">Your recommended learning resources will appear here.</p>
