...
export default function ExploreSkills() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center min-h-[60vh]">
      <h1 className="text-3xl font-bold text-[#1A1D21] mb-4">Explore Skills</h1>
      <p className="text-lg text-gray-500 mb-6">Discover skills, prerequisites, projects, and career paths.</p>
